...
##				expand_outputs = post_processing_cell(mel_outputs)
				linear_postnet = Postnet(is_training, channels=decoder_output.shape[-1], hparams=hp,
...
#					hparams=self._hparams)
				...
				# Compute loss of predictions before postnet
				before = 0.0 #tf.losses.mean_squared_error(self.mel_targets, self.decoder_output)
				# Compute loss after postnet
